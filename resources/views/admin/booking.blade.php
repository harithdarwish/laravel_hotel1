                ...
                <div class="container-fluid">
                    ...
                    <table class="table_deg">
                        ...
                        <tr>
                            ...
                            <!-- we at ookings table and want to access room table-->
                            ...
                            <td>
                                <a onclick="return confirm('U sure want to delete this?');" class="btn btn-danger" href="{{ url('delete_booking', $data->id) }}" >Delete </a>
                            </td>
